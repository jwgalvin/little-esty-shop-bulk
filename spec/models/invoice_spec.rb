...
RSpec.describe Invoice, type: :model do
  ...
  describe 'class methods' do
    ...
    invoice_item1 = InvoiceItem.create!(invoice_id: invoice1.id, item_id: item2.id, quantity: 10, unit_price: 20000, status: 0)
    invoice_item3 = InvoiceItem.create!(invoice_id: invoice1.id, item_id: item3.id, quantity: 8, unit_price: 500, status: 0)
    invoice_item4 = InvoiceItem.create!(invoice_id: invoice2.id, item_id: item1.id, quantity: 2, unit_price: 125, status: 1)
    ...
    invoice_item9 = InvoiceItem.create!(invoice_id: invoice5.id, item_id: item2.id, quantity: 1, unit_price: 2000, status: 2)
    discount1 = merchant1.discounts.create!(name: "Floppies bday", threshold: 10, percent:25)
    ...
    #binding.pry
    #expect(invoice1.dis_counter).to eq()
    end
  end
end
